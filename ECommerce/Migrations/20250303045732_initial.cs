    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "In house product" },
                    { 2, 2, "Eco-friendly product" },
                    { 3, 3, "100% Natural" },
                    { 4, 4, "Made from natural wool" },
                    { 5, 5, "Handmade product" },
                    { 6, 6, "Footwear" },
                    { 7, 7, "Decoration" },
                    { 8, 8, "Pet product" },
                    { 9, 9, "Felt craft" },
                    { 10, 10, "Lifestyle" },
                    { 11, 11, "Festival product" },
                    { 12, 12, "Pashminas" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "200*300cm", 12, "Praesent vitae sodales libero. Praesent molestie orci augue, vitae euismod velit sollicitudin ac. Praesent vestibulum facilisis nibh ut ultricies.\r\n\r\nNunc malesuada viverra ipsum sit amet tincidunt. ", "PRO01", 17000.0, "Muffler" },
                    { 2, "Cosplay", 11, "Praesent vitae sodales libero. Praesent molestie orci augue, vitae euismod velit sollicitudin ac. Praesent vestibulum facilisis nibh ut ultricies.\r\n\r\nNunc malesuada viverra ipsum sit amet tincidunt. ", "PRO02", 4000.0, "Spiderman Mask" }
                });
